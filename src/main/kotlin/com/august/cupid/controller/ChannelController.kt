...
class ChannelController(
    ...
    fun getChannels(
        ...
        return try {
            ...
            val result = channelService.getUserChannels(userIdUuid, page, size)
    ...
    fun createChannel(
        ...
        return try {
            val userIdUuid = UUID.fromString(userId)
            val result = channelService.createChannel(request, userIdUuid)
    ...
    fun leaveChannel(
        ...
        return try {
            ...
            val result = channelService.removeUserFromChannel(channelIdUuid, userIdUuid, userIdUuid)
